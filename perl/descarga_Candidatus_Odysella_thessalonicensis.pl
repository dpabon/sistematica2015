#Descarga del genoma de Candidatus Odysella thessalonicensis L13
use strict;
use Bio::Perl;
my @numero=('1'..'9');
foreach my $elemento (@numero){
  my $gi = 'AEWF0100000'.$elemento; # identificador conocido # prueba NP_417816 con red lenta
  #my $gbfile  = $gi . '.gb';
  my $fnafile = $gi . '.fna';
...
my @numero=('10'..'20');
foreach my $elemento (@numero){
  my $gi = 'AEWF010000'.$elemento; # identificador conocido # prueba NP_417816 con red lenta
  #my $gbfile  = $gi . '.gb';
  my $fnafile = $gi . '.fna';
