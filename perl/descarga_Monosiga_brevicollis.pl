#Descarga Monosiga brevicollis MX1 + Mitocondrion
use strict;
use Bio::Perl;
my @numero=('1'..'9');
foreach my $elemento (@numero){
  my $gi = 'ABFJ0100000'.$elemento; # identificador conocido # prueba NP_417816 con red lenta
  #my $gbfile  = $gi . '.gb';
  my $fnafile = $gi . '.fna';
...
my @numero=('10'..'50');
foreach my $elemento (@numero){
  my $gi = 'ABFJ010000'.$elemento; # identificador conocido # prueba NP_417816 con red lenta
  #my $gbfile  = $gi . '.gb';
  my $fnafile = $gi . '.fna';
