...
pb -d ~/Copy/proyecto/data/processed/prueba_piloto/alineamientos_modificados/Compendio.aln Cadena1 &
pb -d ~/Copy/proyecto/data/processed/prueba_piloto/alineamientos_modificados/Compendio.aln Cadena2 
